...
function immo_termine_setup()
	{
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__('Primary', 'immo-termine'),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'immo_termine_custom_background_args',
				array(
...
add_action('after_setup_theme', 'immo_termine_setup');
...
add_action('wp_enqueue_scripts', 'bag_styles');
